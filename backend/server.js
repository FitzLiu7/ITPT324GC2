...
app.post('/sign-up', async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Sign-Up successful. Please check your email for the confirmation code.', user });
    } catch (error) {
...
app.post('/confirm-sign-up', async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Confirmation successful. You can now sign in.', result });
    } catch (error) {
